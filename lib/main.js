...
const languageServer = atom.config.get('ide-java.languageServer')
const serverDownloadUrl = languageServer.uri
const launcherVersion = languageServer.launcherVersion
const serverLauncher = `/plugins/org.eclipse.equinox.launcher_${launcherVersion}.jar`
const minJavaRuntime = 11
...
class JavaLanguageClient extends AutoLanguageClient {
  ...
  installServer (serverHome) {
    ...
    const provideInstallStatus = (bytesDone, percent) => {
      this.updateInstallStatus(`downloading...)`)
    }
